...
#endif
#if defined(CONFIG_TOUCHSCREEN_BT532_TS) ||defined(CONFIG_TOUCHSCREEN_BT432_TS)
int flag =0;
extern void tsp_charger_enable(int status);
#endif
