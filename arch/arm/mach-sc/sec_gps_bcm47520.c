...
static int gps_enable_control(int flag)
{
    ...
    if (flag && (!f_enabled)) {
#if defined(CONFIG_MACH_CORE3_W) || defined(CONFIG_MACH_GOYAVE3G) || defined(CONFIG_MACH_GOYAVEWIFI) || defined(CONFIG_MACH_VIVALTO5MVE3G) || defined(CONFIG_MACH_GRANDNEOVE3G)
